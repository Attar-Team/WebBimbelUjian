          ...
          <div class="d-flex align-items-end row">
            <div class="col-sm-7">
              <div class="card-body">
                ...
                <p class="mb-4">
                  Selamat melihat aktivitas pemesanan pada penjualan anda
                </p>
          ...
          <div class=" col-12  col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <h3 class="card-title mb-2">{{ FormatRupiah::Rupiah($pemasukan) }}</h3>
                <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>{{ FormatRupiah::Rupiah($pemasukanDays) }}</small>
              </div>
            </div>
          </div>
            ...
            <div class="tab-content p-0">
              <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
                <div class="d-flex p-4 pt-3">
                  ...
                  <div>
                    <h5 class="text-muted d-block">Grafik Penjualan</h5>
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>{{ $pemesananDays }}</small>
              </div>
            </div>
          </div>
          <div class="col-6 mb-4">
            <div class="card">
              <div class="card-body">
                ...
                <span class="d-block mb-1">Paket</span>
                <h3 class="card-title text-nowrap mb-2">{{ $package }}</h3>
          ...
          <div class="col-6 mb-4">
            <div class="card">
              <div class="card-body">
                <div class="card-title d-flex align-items-start justify-content-between">
                  <div class="avatar flex-shrink-0">
                    <i class="rounded fa-solid fa-user" style="padding: 13px;background-color: rgb(87, 237, 237,0.4)"></i>
                  </div>
                  <div class="dropdown">
                    <button
                      class="btn p-0"
